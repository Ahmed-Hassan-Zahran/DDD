...
{
    public class DDDDbMigrationService : ITransientDependency
    {
        public ILogger<DDDDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IDDDDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public DDDDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IDDDDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<DDDDbMigrationService>.Instance;
        }
